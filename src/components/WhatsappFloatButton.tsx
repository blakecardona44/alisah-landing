...
const WhatsappFloatButton: React.FC<WhatsappFloatButtonProps> = () => {
  return (
    <div>
      <a
        style={{ color: 'white' }}
        href="https://api.whatsapp.com/send/?phone=19492976131&text=Hello,%20i%20am%20interested%20in%20the%20services%20provided%20by%20Elizabeth%20Nora%20Jones%20and%20would%20like%20to%20know%20more."
